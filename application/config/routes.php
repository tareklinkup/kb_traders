...
$route['get_product_category_wise'] = 'Administrator/products/getProductCategoryWise'; 
...
$route['save_last_update_date'] = 'Administrator/Purchase/saveLastUpdateDate';
...
$route['get_profitloss'] = 'Administrator/Sales/getProfitLossFilters';
...
$route['balance_report'] = 'Administrator/Reports/balanceReport';
$route['get_balance_report'] = 'Administrator/Reports/getBalanceReport';
...
// database backup
$route['software_database_backup'] = 'Administrator/Page/databaseBackup';