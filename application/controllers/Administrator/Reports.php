...
class Reports extends CI_Controller {
    ...
    public function balanceReport()
    {
        ...
        $datas['title'] = "Balance Report";
        $data['content'] = $this->load->view('Administrator/reports/balance_report', $datas, TRUE);
        $this->load->view('Administrator/index', $data);
    }
    ...
    // public function getBranchStockValue($branchId, $date) {
    //     $stocks = $this->db->query("
    //         select
    ...
    public function getBalanceReport()
    {
        ...
        try {
            ...
            $wholesale_due = $this->mt->customerDue(" and c.status = 'a' and c.Customer_Type = 'wholesale'", $date);
            $retail_due = $this->mt->customerDue(" and c.status = 'a' and c.Customer_Type = 'retail'", $date);
