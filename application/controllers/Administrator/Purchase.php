...
class Purchase extends CI_Controller
{
        ...
        try{
            ...
            foreach($data->cart as $product){
                ...
                $this->db->query("
                    ...
                    and branch_id = ?
                    and cat_id = ?
                ", [$product->return_quantity, $product->Product_IDNo,$product->brunch_id,$product->cat_id]);
            }
    ...
    function addDamage()
    {
        ...
        try {
            ...
            $this->db->query("
                ...
                and ci.branch_id = ?
                and ci.cat_id =? 
            ", [$data->DamageDetails_DamageQuantity, $data->Product_SlNo, $data->branch_id,$data->cat_id]);
    ...
    public function saveLastUpdateDate(){
       $updateDate =  $this->input->post('updateDate');
       $data = array(
           'last_update_soft_date'=>$updateDate
       );
       $this->db->where('last_update_soft_id','1');
       $result = $this->db->update('tbl_last_update_software',$data);
       echo 'updated';
    }
    ...
    public function updateDamage(){
        ...
        try {
            ...
            $this->db->query("
                ...
                and ci.branch_id = ?
                and ci.cat_id = ?
            ", [$oldProduct->DamageDetails_DamageQuantity, $oldProduct->Product_SlNo, $data->branch_id,$data->cat_id]);
    ...
    public function getDamages(){
        ...
        $damages = $this->db->query("
            ...
            join tbl_brunch b on dd.branch_id = b.brunch_id
            join tbl_productcategory c on dd.cat_id=c.ProductCategory_SlNo
