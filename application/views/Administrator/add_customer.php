	...
	<form @submit.prevent="saveCustomer">
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			...
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Page Number:</label>
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="customer.page_number">
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						...
						<input type="radio" name="customerType" value="unpaid" v-model="customer.Customer_Type"> Unpaid
					</div>
				</div>
