			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr style="font-weight:bold;">
						...
						<td style="text-align: right;">{{ payments[payments.length - 1]?.balance.toFixed(2) ?? '0.00' }}</td>
					</tr>
				</tbody>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-xs-6" style="font-size:12px;">
								...
								<strong>Owner name: </strong> ${this.selectedCustomer.owner_name}<br>
								<strong>Business Name: </strong> ${this.selectedCustomer.Customer_Name}<br>
