					...
					<div class="row">
						<div class="col-sm-5">
							<div class="form-group clearfix" style="margin-bottom: 8px;">
								...
								<div class="col-sm-8">
									...
									<div class="row">
										<div class="col-sm-5">
											<input type="radio" name="salesType" value="unpaid" v-model="sales.salesType" v-on:change="onSalesTypeChange"> Unpaid
										</div>
									</div>
						...
						<div class="col-sm-2">
							...
							<div class="form-group" style="margin-top:15px">
								<input type="checkbox" v-model="sales.send_sms" checked> Send SMS
							</div>
						</div>
					</div>
				</div>
	...
	new Vue({
		...
		methods: {
			...
			async onChangeCategory() {
				...
				await axios.post('/get_product_category_wise', {
					catId: this.selectedCategory.ProductCategory_SlNo,
