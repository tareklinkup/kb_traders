...
if ($module == 'dashboard' or $module == '') { ?>
	<div class="row">
		<div class="col-md-12 col-xs-12">
			<!-- Header Logo -->
			<div class="col-md-12">
				<img src="<?php echo base_url(); ?>assets/images/kb_logo.jpg" class="img img-responsive center-block" style="height:250px; width: 1020px;">
				<h4 class="text-center" style="font-weight:bold;color:red;">ব্যবস্থাপনা পরিচালক: শ্রী বিধান কুমার সাহা</h4>
			
			<h5 style="text-align: center;">Add last Update  <button id="lastupdateaddbutton"  class="btn btn-sm btn-success">+</button></h5>
...
<h4 style="text-align: center;
    ...
    color: #0f3e03;
    font-weight: bold;
	margin-top: 18px;">Last Update  :  <?php 
	$row = $this->db->query("select * from tbl_last_update_software where last_update_soft_id='1'")->row();
    echo $row->last_update_soft_date;
	?> </h4>
			</div>
<!-- Last update Entry modal -->
<div class="modal fade" id="lastUpdateDataAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title" >Last update date Add </h6>
	  ...
	  <div class="form-group">
            <label for="recipient-name" class="col-form-label">Add update Date:</label>
            <input type="date" class="form-control" id="addupdatedate">
          </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" id="saveLastUpdate">Save changes</button>
      </div>
    </div>
  </div>
</div>
...
<!--  -->
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<?php if (isset($CheckSuperAdmin)) : ?>
					<div class="col-md-3 section4">
						<div class="col-md-12 section122" style="background-color:rgb(70 177 177)" onmouseover="this.style.background = 'rgb(90 177 177)'" onmouseout="this.style.background = 'rgb(70 177 177)'">
							<a href="<?php echo base_url(); ?>software_database_backup">
								<div class="logo">
	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-10">
				...
				<?php if (array_search("balance_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
					<div class="col-md-2">
						<div class="col-md-12 section20">
							<a href="<?php echo base_url(); ?>balance_report">
								<div class="logo">
									<i class="menu-icon fa fa-credit-card-alt"></i>
								</div>
								<div class="textModule">
