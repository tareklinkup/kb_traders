...
class Customer extends CI_Controller
{
    ...
    public function getCustomers(){
        ...
        if(isset($data->searchType) && $data->searchType=='retail'){
           $customerTypeClause = " and Customer_Type='retail'";
        }
        if(isset($data->searchType) && $data->searchType=='wholesale'){
            $customerTypeClause = " and Customer_Type='wholesale'";
         }
