						...
						<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<br>
									<p style="margin:0;padding:0;margin-left:16px;"></p>
								</div>
	...
	new Vue({
		...
		methods:{
			...
			async onChangeCategory(){
				  ...
				  await axios.post('/get_product_category_wise',{catId:this.selectedCategory.ProductCategory_SlNo,branchId:this.selectedBranch.brunch_id,stockFilter:'yes'}).then(res=>{
			...
			async productOnChange(){ 
				...
				if((this.selectedProduct.Product_SlNo != '' || this.selectedProduct.Product_SlNo != 0) && this.sales.isService == 'false'){
					this.productStock = await axios.post('/get_product_stock', {productId: this.selectedProduct.Product_SlNo,branchId:this.selectedBranch.brunch_id,categoryId:this.selectedCategory.ProductCategory_SlNo,
			...
			addToCart(){
				...
				// return false
				let cartInd = this.cart.findIndex(p => p.productId == product.productId && p.branchId==product.branchId);
				if(cartInd > -1){
