        ...
        <div class="col-md-12">
            <form class="form-horizontal" @submit.prevent="saveBranch">
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" placeholder="Warehouse Name" class="form-control" v-model="branch.name" required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label no-padding-right">:</label>
                    <div class="col-sm-3">
                        <input type="text" placeholder="Warehouse Title" class="form-control" v-model="branch.title" required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label no-padding-right">:</label>
                    <div class="col-sm-3">
                        <textarea class="form-control" placeholder="Warehouse Address" v-model="branch.address" required></textarea>
                    </div>
                </div>
