			...
			<div class="footer">
				<div class="footer-inner">
					<div class="footer-content">
						...
						Purchased by KB Agro Food 01759-011567 
						</span>
...
$('#lastupdateaddbutton').click(function(){
			$('#lastUpdateDataAdd').modal('show');
		})

		$(document).on('click','#saveLastUpdate',function(){ 
			var updateDate = $('#addupdatedate').val();
			$.ajax({
				url:"/save_last_update_date",
				method:"POST",
				data:{updateDate:updateDate},
				success:function(data){
					if(data.trim()=='updated'){
						$('#lastUpdateDataAdd').modal('hide');
