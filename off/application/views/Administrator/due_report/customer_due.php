...
<div class="row" id="customerDueList">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		...
		<div class="form-group" style="display: none" v-bind:style="{display: searchType == 'customer' || searchType == 'retail' || searchType == 'wholesale'  ? 'block' : 'none'}">
...
<script>
	...
	new Vue({
		...
		methods:{
			onChangeSearchType(){
				if(this.searchType == 'customer' || this.searchType=='retail' || this.searchType=='wholesale'){
					this.getCustomers();
				}
			...
			getCustomers(){
				axios.post('/get_customers',{searchType:this.searchType}).then(res => {
			...
			getDues(){
				...
				if(this.searchType == 'retail' || this.searchType == 'wholesale') {
