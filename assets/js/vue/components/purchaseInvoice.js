const purchaseInvoice = Vue.component('purchase-invoice', {
        ...
        <div>
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-6 col-xs-offset-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                <td><strong>Own Transport Cost:</strong></td>
                                <td style="text-align:right">{{ purchase.own_freight }}</td>
                            </tr>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div v-if="totalDue > 0">
                            <strong>Total Due Amount in Word: </strong> {{ convertNumberToWords(totalDue) }}<br><br>
                        </div>
                        <strong>Note: </strong>
    ...
    computed: {
        totalDue() {
            return (parseFloat(this.purchase.previous_due) + parseFloat(this.purchase.PurchaseMaster_DueAmount == null ? 0.00 : this.purchase.PurchaseMaster_DueAmount)).toFixed(2);
        }
    },
    created(){
        this.setStyle();
