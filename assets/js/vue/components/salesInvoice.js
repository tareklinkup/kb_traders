                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                <td>
                                    <strong v-if="lang == 'bn'">পরিবহন খরচ:</strong>
            ...
            if (this.currentBranch.print_type == '3') {
                printWindow.document.write(`
                    <html>
                        ...
                        <body>
                            <div class="row">
                            <div class="col-xs-2" style="margin-left: 19%;"><img  src="/uploads/branch_thum/${this.currentBranch.Company_Logo_thum}" alt="Logo" style="height:105px;    margin-top: 32px;" /></div>
                ...
                printWindow.document.write(`
                    ...
                    <div style="float:left;width:48%">
                        <div class="row">
                            <div class="col-xs-12" style=""><img  src="/uploads/branch_thum/${this.currentBranch.Company_Logo_thum}" alt="Logo" style="height:105px;    margin-top: 32px;width:100%" /></div>
				...
				printWindow.document.write(`
                    ...
                    <body>
                        ...
                        <div class="row" style="text-align:center;">
                            <div class="col-xs-12"><img  src="/uploads/branch_thum/${this.currentBranch.Company_Logo_thum}" alt="Logo" style="height:105px;margin-top: 32px;" /></div>
